    ...
    <div className="min-h-screen bg-kaizen-bg flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10 space-y-6">
        ...
        <div className="flex flex-col items-center text-center space-y-2">
          ...
          <span className="text-xs font-mono text-kaizen-subtle uppercase tracking-widest">Create Athlete Account</span>
        </div>

        <Card title="Start Your Journey" subtitle="Build progressive strength and precision nutrition" className="card-sheen shadow-subtle">
